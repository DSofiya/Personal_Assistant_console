...
До записної книжки можна додавати контакти, їх ім'я, номер, дату народження, емейл та адресу.
...
Застосунок автоматично зберігає усю інформацію на диск, запобігаючи видаленню інформації при помилці чи непередбачуванному вимкненню застосунку.
...
Застосунок створений для візуалізації та пошуку координат на мапах. Основною 
...
Інструкція користання командами:
save – усі команди з таким префіксом зберігають мапу з нанесеними мітками 
